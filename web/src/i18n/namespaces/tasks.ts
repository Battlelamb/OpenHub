export const en = {
  ...
  dialogDescription: "Describe the task, choose matching capabilities, then dispatch it to the queue.",
...
export const tr = {
  ...
  dialogDescription: "Gorevi acikla, gerekli yetenekleri sec ve kuyruga gonder.",
