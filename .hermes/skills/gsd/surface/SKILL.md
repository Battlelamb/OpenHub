...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/brunhilde/OpenHub/.hermes/.gsd-surface.json`
(sibling to `/home/brunhilde/OpenHub/.hermes/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/brunhilde/OpenHub/.hermes/skills/gsd-*/`.
...
The `runtimeConfigDir` for `applySurface` is the **Hermes Agent local config directory**
(`/home/brunhilde/OpenHub/.hermes`), NOT the skills sub-directory (`/home/brunhilde/OpenHub/.hermes/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which receive the
runtime config root as `configDir`. The skill dirs themselves live under
`/home/brunhilde/OpenHub/.hermes/skills/gsd/` and are derived from `configDir`, not used as the root for it.

```bash
# Hermes Agent — local install for this repository
RUNTIME_CONFIG_DIR="/home/brunhilde/OpenHub/.hermes"
SCOPE="local"
...
(i.e. `/home/brunhilde/OpenHub/.hermes/.gsd-surface.json`).

For global Hermes installs, resolve the runtime config root from `HERMES_HOME` or the Hermes default home.
...
<execution_context>
Surface state file: `/home/brunhilde/OpenHub/.hermes/.gsd-surface.json`
Install profile marker: `/home/brunhilde/OpenHub/.hermes/.gsd-profile`
Skill dirs: `/home/brunhilde/OpenHub/.hermes/skills/gsd-*/`
Engine module: `/home/brunhilde/OpenHub/.hermes/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/brunhilde/OpenHub/.hermes/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
