...
- **Global scope**: `/home/brunhilde/OpenHub/.hermes/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/brunhilde/OpenHub/.hermes/notes/`)
...
2. Glob `/home/brunhilde/OpenHub/.hermes/notes/*.md` (if directory exists) — global notes
...
Global (/home/brunhilde/OpenHub/.hermes/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/brunhilde/OpenHub/.hermes/notes/` — works in any directory
