...
```
Agent(
  prompt="Read /home/brunhilde/OpenHub/.hermes/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/brunhilde/OpenHub/.hermes/get-shit-done/templates/VALIDATION.md`
