...
```bash
INIT=$(node "/home/brunhilde/OpenHub/.hermes/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/brunhilde/OpenHub/.hermes/get-shit-done/bin/gsd-tools.cjs" commit \
