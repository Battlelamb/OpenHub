...
```bash
INIT=$(node "/home/brunhilde/OpenHub/.hermes/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/brunhilde/OpenHub/.hermes/get-shit-done/templates/spec.md.
