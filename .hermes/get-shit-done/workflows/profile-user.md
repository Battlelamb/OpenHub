...
Key references:
- @/home/brunhilde/OpenHub/.hermes/get-shit-done/references/ui-brand.md (display patterns)
- @/home/brunhilde/OpenHub/.hermes/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/brunhilde/OpenHub/.hermes/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/brunhilde/OpenHub/.hermes/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/brunhilde/OpenHub/.hermes/get-shit-done/USER-PROFILE.md" "/home/brunhilde/OpenHub/.hermes/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/brunhilde/OpenHub/.hermes/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/brunhilde/OpenHub/.hermes/get-shit-done/references/user-profiling.md`
...
Reference: @/home/brunhilde/OpenHub/.hermes/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/brunhilde/OpenHub/.hermes/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global HERMES.md" -- "Add profile to /home/brunhilde/OpenHub/.hermes/HERMES.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/brunhilde/OpenHub/.hermes/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/brunhilde/OpenHub/.hermes/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/brunhilde/OpenHub/.hermes/HERMES.md"
...
```bash
BACKUP_PATH="/home/brunhilde/OpenHub/.hermes/USER-PROFILE.backup.md"
```
...
Your profile:    /home/brunhilde/OpenHub/.hermes/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/brunhilde/OpenHub/.hermes/skills/gsd-dev-preferences/SKILL.md
  ✓ HERMES.md section       ./HERMES.md
  ✓ Global HERMES.md        /home/brunhilde/OpenHub/.hermes/HERMES.md
```
