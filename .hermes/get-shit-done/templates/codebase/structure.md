...
- Usage: Reference from command with `@/home/brunhilde/OpenHub/.hermes/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/brunhilde/OpenHub/.hermes/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/brunhilde/OpenHub/.hermes/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
