...
<reference>
@/home/brunhilde/OpenHub/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/brunhilde/OpenHub/.codex/get-shit-done/references/user-profiling.md` to load:
