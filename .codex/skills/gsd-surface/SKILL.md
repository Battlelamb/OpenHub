...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/brunhilde/OpenHub/.codex/.gsd-surface.json`
(sibling to `/home/brunhilde/OpenHub/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/brunhilde/OpenHub/.codex/skills/gsd-*/`.
...
The `runtimeConfigDir` for `applySurface` is the **Codex local config directory**
(`/home/brunhilde/OpenHub/.codex`), NOT the skills sub-directory (`/home/brunhilde/OpenHub/.codex/skills`).
...
`/home/brunhilde/OpenHub/.codex/skills/` and are derived from `configDir`, not used as the root for it.

```bash
# Codex — local install for this repository
RUNTIME_CONFIG_DIR="/home/brunhilde/OpenHub/.codex"
SCOPE="local"
...
(i.e. `/home/brunhilde/OpenHub/.codex/.gsd-surface.json`).

For global Codex installs, resolve the runtime config root from `CODEX_HOME` or the Codex default home.
...
<execution_context>
Surface state file: `/home/brunhilde/OpenHub/.codex/.gsd-surface.json`
Install profile marker: `/home/brunhilde/OpenHub/.codex/.gsd-profile`
Skill dirs: `/home/brunhilde/OpenHub/.codex/skills/gsd-*/`
Engine module: `/home/brunhilde/OpenHub/.codex/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/brunhilde/OpenHub/.codex/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
