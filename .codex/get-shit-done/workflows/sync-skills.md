...
INSTALL_JS_GLOBAL="/home/brunhilde/OpenHub/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/brunhilde/OpenHub/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
