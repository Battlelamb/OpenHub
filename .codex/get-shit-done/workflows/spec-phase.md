...
```bash
INIT=$(node "/home/brunhilde/OpenHub/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/brunhilde/OpenHub/.codex/get-shit-done/templates/spec.md.
