...
```bash
INIT=$(node "/home/brunhilde/OpenHub/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/brunhilde/OpenHub/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
