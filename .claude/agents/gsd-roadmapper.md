...
Reference full template: `/home/brunhilde/OpenHub/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/brunhilde/OpenHub/.claude/get-shit-done/templates/state.md`.
