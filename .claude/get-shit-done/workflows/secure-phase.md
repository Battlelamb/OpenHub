...
```
Agent(
  prompt="Read /home/brunhilde/OpenHub/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/brunhilde/OpenHub/.claude/get-shit-done/templates/SECURITY.md`
