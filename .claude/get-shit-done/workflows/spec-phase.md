...
```bash
INIT=$(node "/home/brunhilde/OpenHub/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/brunhilde/OpenHub/.claude/get-shit-done/templates/spec.md.
