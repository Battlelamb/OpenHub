...
```bash
INIT=$(node "/home/brunhilde/OpenHub/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/brunhilde/OpenHub/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
