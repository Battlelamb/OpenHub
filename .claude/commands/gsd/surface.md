...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/brunhilde/OpenHub/.claude/.gsd-surface.json`
(sibling to `/home/brunhilde/OpenHub/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/brunhilde/OpenHub/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/brunhilde/OpenHub/.claude/skills`).
...
`/home/brunhilde/OpenHub/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/brunhilde/OpenHub/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/brunhilde/OpenHub/.claude/.gsd-surface.json`
Install profile marker: `/home/brunhilde/OpenHub/.claude/.gsd-profile`
Skill dirs: `/home/brunhilde/OpenHub/.claude/skills/gsd-*/`
Engine module: `/home/brunhilde/OpenHub/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/brunhilde/OpenHub/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
